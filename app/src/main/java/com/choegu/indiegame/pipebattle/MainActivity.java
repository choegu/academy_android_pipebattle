...
public class MainActivity extends AppCompatActivity {
    // Layout
    private Button btnEnter, btnSetting, btnRanking, btnExit;
    ...
    private void showLoginDialog() {
        ...
        builder.setView(dialogView)
                ...
                .setPositiveButton("확인", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        if ((loginEditId.getText()+"").trim().equals("")) {
                            Toast.makeText(MainActivity.this, "이용할 ID를 입력하세요.",Toast.LENGTH_SHORT).show();
                        } else {
                            Intent intent = new Intent(MainActivity.this, ListActivity.class);
                            intent.putExtra("loginId", loginEditId.getText()+"");
